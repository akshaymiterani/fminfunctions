...
public:
  // Constructor
    	minuncTMINLP(Index nV, Index nC,Number *x0,Number f1, Number f2, Index intconSize, Number *intcon):numVars_(nV),numConstr_(nC),varGuess_(x0),flag1_(f1),flag2_(f2),intconSize_(intconSize),intcon_(intcon),finalX_(0),finalGradient_(0),finalHessian_(0),finalObjVal_(1e20){	}
